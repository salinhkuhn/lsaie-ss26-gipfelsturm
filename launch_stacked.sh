#!/bin/bash
#
# launch_stacked.sh — Experiment: stacked throughput improvements for 8B.
#
# Sibling of launch.sh. Goal: beat 14.5k tok/s/GPU baseline by
# stacking the levers we never tried or combined.
#
...
#
# Usage: ./launch_stacked.sh throughput 8b 50 1
