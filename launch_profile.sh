#!/bin/bash
#
# launch_profile.sh — Experiment-specific launcher: throughput profiling baseline.
#
# Sibling of launch.sh  BUT added profiling logic to detect current throughput bottlneck ?
#
# Differences vs launch.sh:
#   - TRAINING_ARGS adds 6 flags: --profile --use-pytorch-profiler
#                                 --profile-step-start 10 --profile-step-end 12
#                                 --profile-ranks 0 --tensorboard-dir
#
# Usage: ./launch_profile.sh <mode> <model_size> [steps] [nodes]
# Example: ./launch_profile.sh throughput 8b 50 1
#
# Output: chrome trace JSON at $TENSORBOARD_DIR/*.pt.trace.json
...
# Logging
PROJECT_NAME=gipfelsturm-throughput-profile
